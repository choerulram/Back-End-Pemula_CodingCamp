...
const addBookHandler = (request, h) => {
  ...
  const bookYear = year || 0;
  const bookPageCount = pageCount || 0;
  const bookReadPage = readPage || 0;
  const isReading = reading !== undefined ? reading : false;
